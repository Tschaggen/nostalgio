    ...
    render() {
      return( 
        <div className='hotbar' id='hotbar'>
            ...
            <button onClick={() => {this.props.setScreen('myprofile'); return false;}} className='my-profile-button'>
            ...
            <button onClick={() => {this.props.setScreen('timeline'); return false;}} className='my-profile-button'>
