        ...
        <div className='post' id={'post-'+this.props.id}>
            ...
            <div className='post-interaction-wrapper'>
              ...
              onSubmit={(e) => {
                ...
                fetch(document.location.protocol + '//' + document.location.host+'/api/Post/Comment', options);
              }}>
              ...
              onClick={(e) => {
                ...
                fetch(document.location.protocol + '//' + document.location.host+'/api/Post/Like',options)
